                ...
                <form method="GET">
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-3 d-flex justify-content-md-end mt-3 mt-md-0">
                            <a href="{{ route('orgs.inventories.create', $org->id) }}" class="btn btn-primary btn-sm rounded-pill me-2">
                                <i class="bi bi-plus-circle-fill"></i> Nuevo
                            </a>
                            <a href="{{ route('orgs.inventories.export', $org->id) }}" class="btn btn-primary btn-sm rounded-pill">
