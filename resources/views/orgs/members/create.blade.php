            ...
            <div class="card-body">
                <form id="newMemberForm" action="{{ route('orgs.members.store', $org->id) }}" method="POST">
                            ...
                            <div class="mb-3 row">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="state" name="state">
                                        ...
                                        <option value="{{$state->id}}" {{ old('state') == $state->id ? 'selected' : '' }}>{{$state->name_state}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-4">
                        ...
                        <div class="col-md-6 ps-md-4">
                            <h5 class="text-primary mb-3">Información de Servicios <span class="text-muted fs-6 fw-normal"></span></h5>
                                <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select" id="meter_plan" name="meter_plan">
                                            <option value="">Seleccionar</option>
                                            <option value="si" {{ old('meter_plan') == 'si' ? 'selected' : '' }}>Sí</option>
                                            <option value="no" {{ old('meter_plan') == 'no' ? 'selected' : '' }}>No</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="percentage" class="form-label">Porcentaje</label>
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="percentage" name="percentage" min="0" max="100" value="{{ old('percentage') }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select" id="meter_type" name="meter_type">
                                            ...
                                            <option value="analogico" {{ old('meter_type') == 'analogico' ? 'selected' : '' }}>Análogo</option>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="meter_number" name="meter_number" value="{{ old('meter_number') }}">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select" id="invoice_type" name="invoice_type">
                                            ...
                                            <option value="boleta" {{ old('invoice_type') == 'boleta' ? 'selected' : '' }}>Boleta Exenta</option>
                        ...
                        <div class="form-check mb-3">
                            ...
                            <label class="form-check-label" for="activo">Dejar <b>Activo</b> si es nuevo cliente y no tiene servicios asignados</label>
                        </div>
