...
<div class="card-body pt-2">
                <form method="GET" id="filterForm">
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-2 d-flex">
                                <a href="{{route('orgs.members.export',$org->id)}}" class="btn btn-primary w-100 rounded-pill pulse-btn">
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $member->id }}</td>
                                <td class="text-end"><a href="{{route('orgs.members.edit',[$org->id,$member->id])}}">{{ $member->rut }}</a></td>
                                <td>
                                ...
                                <td>@if($member->partner=='socio') <span class="badge bg-success"><i class="bi bi-file-earmark-person me-1"></i> {{ $member->partner }}</span> @else <span class="badge bg-info"><i class="ri-home-smile-2-line me-1"></i> {{ $member->partner }}</span> @endif</td>
