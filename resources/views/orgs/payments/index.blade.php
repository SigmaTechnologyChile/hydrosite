            ...
            <div class="card-body pt-2">
                <form method="GET" id="filterForm">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group input-group-sm search-input-group">
                                ...
                                <input type="text" name="search" class="form-control rounded-end-3"
                                    placeholder="Buscar por nombre, apellido, Rut" value="{{ request('search') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-2 d-flex">
                            <a href="{{route('orgs.payments.export', $org->id)}}"
                                class="btn btn-primary w-100 rounded-pill pulse-btn">
                        ...
                        <tbody>
                            @foreach($members as $member)
                                <tr data-id="{{ $member->id }}">
                                    <td>{{ $member->id }}</td>
                                    <td><a href="{{route('orgs.members.edit', [$org->id, $member->id])}}">{{ $member->rut }}</a>
                                    </td>
                                    ...
                                    @if($member->total_amount == 0)
                                        <span class="badge bg-success ">{{ $member->payment_status }}Sin deudas</span>
                                    @else
                                        <span class="badge bg-warning ">{{ $member->payment_status }}Pendiente de pago</span>
                                    @endif
                                    </td>
                                    <td class="text-end">
                            ...
                            <div class="modal fade" id="editReadingModal" tabindex="-1"
                                aria-labelledby="editReadingModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="editReadingForm" method="POST">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="current_reading"
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" form="editReadingForm"
